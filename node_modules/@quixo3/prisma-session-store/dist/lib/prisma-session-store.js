...
var PrismaSessionStore = /** @class */ (function (_super) {
    ...
    function PrismaSessionStore(prisma, options) {
        ...
        _this.set = function (sid, session, callback) { return __awaiter(_this, void 0, void 0, function () {
            var e_7, ttl, expiresAt, sessionString, data, id, existingSession, e_8;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 5:
                        ...
                        if (!(this.options.enableNativeMysqlSetUpsert === true)) return [3 /*break*/, 7];
                        if (typeof this.prisma.$executeRawUnsafe !== 'function') {
                            throw new Error('enableNativeMysqlSetUpsert requires a Prisma client exposing $executeRawUnsafe.');
                        }
                        return [4 /*yield*/, this.prisma.$executeRawUnsafe('INSERT INTO `Session` (`id`, `sid`, `expiresAt`, `data`) VALUES (?, ?, ?, ?) ON DUPLICATE KEY UPDATE `sid` = VALUES(`sid`), `expiresAt` = VALUES(`expiresAt`), `data` = VALUES(`data`)', id, sid, expiresAt, sessionString)];
                    case 6:
                        _a.sent();
                        return [3 /*break*/, 12];
                    case 7: return [4 /*yield*/, this.prisma[this.sessionModelName]
                            .findUnique({
                            where: { sid: sid },
                        })
                            .catch(function () { return null; })];
                    case 8:
                        ...
                        if (!(existingSession !== null)) return [3 /*break*/, 10];
                    ...
                    case 9:
                        _a.sent();
                        return [3 /*break*/, 12];
                    case 10: return [4 /*yield*/, this.prisma[this.sessionModelName].create({
                            data: __assign(__assign({}, data), { id: id, data: sessionString }),
                        })];
                    case 11:
                        _a.sent();
                        _a.label = 12;
                    ...
                    case 13:
                        e_8 = _a.sent();
                        this.logger.error("set(): ".concat(String(e_8)));
                        // Clear flag, to indicate that set() operation
                        // is no longer in progress for this sid.
                        this.isSetting.delete(sid);
                        if (callback)
        ...
        _this.touch = function (sid, session, callback) { return __awaiter(_this, void 0, void 0, function () {
            var ttl, expiresAt, existingSession, existingSessionData, e_9;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 6:
                        e_9 = _b.sent();
                        this.logger.error("touch(): ".concat(String(e_9)));
                        if (callback)
                            (0, utils_1.defer)(callback, e_9);
                        return [3 /*break*/, 8];
                    case 7:
