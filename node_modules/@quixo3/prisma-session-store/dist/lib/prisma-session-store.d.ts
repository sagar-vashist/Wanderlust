...
export declare class PrismaSessionStore<M extends string = 'session'> extends Store {
     ...
     */
    readonly all: (callback?: (err?: unknown, all?: ISessions) => void) => Promise<void | ISessions>;
    /**
     ...
     */
    readonly clear: (callback?: (err?: unknown) => void) => Promise<void>;
    /**
     ...
     */
    readonly destroy: (sid: string | string[], callback?: (err?: unknown) => void) => Promise<void>;
    /**
     ...
     */
    readonly get: (sid: string, callback?: (err?: unknown, val?: SessionData) => void) => Promise<void | SessionData>;
    /**
     ...
     * or an error that occurred
     */
    readonly ids: (callback?: (err?: unknown, ids?: number[]) => void) => Promise<void | string[]>;
    /**
     ...
     * or an error that occurred
     */
    readonly length: (callback?: (err: unknown, length: number) => void) => Promise<number | void>;
    /**
     ...
     * or an error that occurred
     */
    readonly set: (sid: string, session: PartialDeep<SessionData>, callback?: (err?: unknown) => void) => Promise<void>;
    /**
     ...
     */
    readonly touch: (sid: string, session: PartialDeep<SessionData>, callback?: (err?: unknown) => void) => Promise<void>;
}
